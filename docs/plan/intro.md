...
I think a proper introduction should be shaped like:
...
However, I want more systematic way to build the few-shot example, and it should at least validate the LLM is saying something clearly (which is a problem in a lot of LLMs). Probably I can't go this far for now.